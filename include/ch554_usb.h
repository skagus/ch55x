...
#define USB_BO_CBW_SIZE			0x1F	/* Total length of the cmd block CBW */
#define USB_BO_CSW_SIZE			0x0D	/* Total length of the cmd status block CSW */
#endif
#ifndef USB_BO_CBW_SIG0
#define USB_BO_CBW_SIG0         0x55    /* Cmd block CBW identification flag 'USBC' */
#define USB_BO_CBW_SIG1         0x53
#define USB_BO_CBW_SIG2         0x42
#define USB_BO_CBW_SIG3         0x43
#define USB_BO_CSW_SIG0         0x55    /* Cmd Status block CSW identification flag 'USBS' */
