...
void _SendKeyScan(uint8_t nDrvIdx, uint8_t nPrv, uint8_t nCur)
{
	...
	{
		KEY_KPPLUS,	KEY_KPMINUS,	KEY_NONE,	KEY_NONE,	KEY_NONE,	KEY_KPENTER,	KEY_NONE,
		KEY_KP7,	KEY_NUMLOCK,	KEY_NONE,	KEY_NONE,	KEY_NONE,	KEY_KP1,	KEY_KP4,
		KEY_KP8,	KEY_KPSLASH,	KEY_NONE,	KEY_NONE,	KEY_KP0,	KEY_KP2,	KEY_KP5,
		KEY_KP9,	KEY_KPASTERISK,	KEY_NONE,	KEY_NONE,	KEY_KPDOT,	KEY_KP3,	KEY_KP6,
	};
